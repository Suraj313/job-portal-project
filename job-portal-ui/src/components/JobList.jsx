                        ...
                        {filteredJobs.length > 0 ? filteredJobs.map(job => (
                             <div key={job.id} className="bg-white/60 backdrop-blur-xl p-6 rounded-xl border border-white/30 shadow-lg transform hover:scale-105 transition-transform duration-300">
                                <h2 className="text-xl font-bold text-gray-900 mb-2 truncate">
                                    <Link to={`/job/${job.id}`} className="hover:text-indigo-600 transition-colors duration-300">
                                        {job.title}
                                    </Link>
                                </h2>
                                ...
                                <div className="pt-4 border-t border-gray-200 text-right">
                                    <Link to={`/job/${job.id}`} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300 shadow-md hover:shadow-lg">
                                        View Details
                                    </Link>
                                </div>
                            </div>
